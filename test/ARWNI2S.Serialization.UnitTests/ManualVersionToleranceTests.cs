...
namespace ARWNI2S.Serialization.UnitTests
{
    ...
    {
        private const string TestString = "hello, ARWNI2S.Serialization";
        ...
        public class SubTypeSerializer : IBaseCodec<SubType>
        {
            ...
            {
                _baseTypeSerializer = NI2SGeneratedCodeHelper.UnwrapService(this, baseTypeSerializer);
                _stringCodec = NI2SGeneratedCodeHelper.UnwrapService(this, stringCodec);
                _intCodec = NI2SGeneratedCodeHelper.UnwrapService(this, intCodec);
                _objectCodec = NI2SGeneratedCodeHelper.UnwrapService(this, objectCodec);
            }
