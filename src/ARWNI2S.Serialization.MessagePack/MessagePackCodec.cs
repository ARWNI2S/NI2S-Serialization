...
using ARWNI2S.Serialization.Buffers.Adaptors;
...
namespace ARWNI2S.Serialization.MessagePack
{
    /// <summary>
    /// A serialization codec which uses <see cref="MessagePackSerializer"/>.
    /// </summary>
    /// <remarks>
    /// MessagePack codec performs slightly worse than default NI2S serializer, if performance is critical for your application, consider using default serialization.
    /// </remarks>
