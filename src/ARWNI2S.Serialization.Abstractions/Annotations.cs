...
namespace ARWNI2S
{
    ...
    public sealed class GenerateSerializerAttribute : Attribute
    {
        ...
        /// <summary>
        /// Get or sets when NI2S should auto-assign field ids. The default behavior is to not auto-assign field ids.
        /// </summary>
    ...
    public sealed class NI2SConstructorAttribute : ActivatorUtilitiesConstructorAttribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NI2SConstructorAttribute"/> class.
        /// </summary>
        public NI2SConstructorAttribute()
        {
        }
    }
