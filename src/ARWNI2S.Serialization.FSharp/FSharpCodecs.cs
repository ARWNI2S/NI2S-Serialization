...
namespace ARWNI2S.Serialization.FSharp
{
    /// <summary>
    ...
    public sealed class FSharpOptionCopier<T> : IDeepCopier<FSharpOption<T>>
    {
        ...
        {
            _valueCopier = NI2SGeneratedCodeHelper.UnwrapService(this, valueCopier);
        }
    ...
    public class FSharpValueOptionCodec<T> : IFieldCodec<FSharpValueOption<T>>
    {
        ...
        {
            _valueCodec = NI2SGeneratedCodeHelper.UnwrapService(this, item1Codec);
        }
