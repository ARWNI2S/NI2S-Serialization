...
namespace ARWNI2S.CodeGenerator
{
    internal class CopierGenerator
    {
            ...
            Dictionary<ISerializableTypeDescription, TypeSyntax> defaultCopiers)
        {
            ...
            var baseType = isExceptionType ? QualifiedName(AliasQualifiedName("global", IdentifierName("ARWNI2S.Serialization.GeneratedCodeHelpers.NI2SGeneratedCodeHelper")), GenericName(Identifier("ExceptionCopier"), TypeArgumentList(SeparatedList(new[] { type.TypeSyntax, type.BaseType.ToTypeSyntax() }))))
        ...
        private ConstructorDeclarationSyntax GenerateConstructor(string simpleClassName, List<GeneratedFieldDescription> fieldDescriptions, bool isExceptionType)
        {
                ...
                switch (field)
                {
                    ...
                    case CopierFieldDescription or BaseCopierFieldDescription when !field.IsInjected:
                        ...
                        var copier = InvocationExpression(
                            IdentifierName("NI2SGeneratedCodeHelper").Member(GenericName(Identifier("GetService"), TypeArgumentList(SingletonSeparatedList(field.FieldType)))),
            ...
            static ExpressionSyntax Unwrapped(ExpressionSyntax expr)
            {
                return InvocationExpression(
                    IdentifierName("NI2SGeneratedCodeHelper").Member("UnwrapService"),
