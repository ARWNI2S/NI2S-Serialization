...
;
        ...
        private INamedTypeSymbol GetBaseClassType(InvokableMethodDescription method)
        {
            ...
            {
                throw new NI2SGeneratorDiagnosticAnalysisException(InvalidRpcMethodReturnTypeDiagnostic.CreateDiagnostic(method));
            }
            ...
            List<InvokerFieldDescription> fields)
        {
            ...
            // C#: default: return NI2SGeneratedCodeHelper.InvokableThrowArgumentOutOfRange(index, {maxArgs})
            var throwHelperMethod = MemberAccessExpression(
                SyntaxKind.SimpleMemberAccessExpression,
                IdentifierName("NI2SGeneratedCodeHelper"),
            ...
            List<InvokerFieldDescription> fields)
        {
            ...
            // C#: default: NI2SGeneratedCodeHelper.InvokableThrowArgumentOutOfRange(index, {maxArgs})
                ...
                if (description is MethodInfoFieldDescription methodInfo)
                {
                    ...
                    field = FieldDeclaration(
                        VariableDeclaration(
                            ...
                            .WithInitializer(EqualsValueClause(
                                InvocationExpression(
                                    IdentifierName("NI2SGeneratedCodeHelper").Member("GetMethodInfoOrDefault"),
                                    ArgumentList(SeparatedList(new[]
                                    {
